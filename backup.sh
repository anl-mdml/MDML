...
docker exec -it mdml_grafana_mysqldb_1 bash -c "mysqldump -u grafana -p grafana > /var/lib/backups/mdml_graf_backup_${DATE}.sql"
cp grafana_mysqldb/backups/mdml_graf_backup_${DATE}.sql backups/${DATE}
